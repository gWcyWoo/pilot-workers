...
def _legacy_deployment(isolated) -> Path:
    ...
    released = subprocess.run(
        ["git", "show",
         "HEAD:src/pilot_workers/integrations/claude-host/skills/pilot-workers/SKILL.md"],
        capture_output=True, text=True, check=True).stdout
    assert install_mod.GENERATED_BEGIN not in released, "fixture assumes no markers"
